...
int32_t main()
{
	...
	int l, r, x, y; cin>> l>>r>>x>>y;
        //a*b = x*y and both a and b should have gcd = x;
        //gcd(a, b) = x and lcm(a,b) = y;
        //a*b = x*y; and a is multiple of x and b is multiple ofx;
        if(y%x!=0)
        {
            cout << 0 << ln;
            return 0;
        ...
        for(int i = l; i*i<=y and i <=r; i++)
        {
            ...
            int b = y/i;
            dbg(a, b);
            if(a>=l and a<=r and b<=r and b>=l and __gcd(a, b)==1)
            {
                if(a==b)
                    ans+=1;
                else
