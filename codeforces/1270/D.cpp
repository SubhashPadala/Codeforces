...
int32_t main()
{
    	...
    	TIE;
#endif
        // Very Very Nice Question, was close to it, but seen editorial.
        // GrandMaster sivaV
        // new things c++
        // max_element(all(v)) returns iterator to mx element
        // count(all(v), x) returns count of x in container v
